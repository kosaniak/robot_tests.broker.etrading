...
Пошук тендера по ідентифікатору
  ...
  ...      ${ARGUMENTS[1]} ==  ${tender_uaid}
    ...
    Go to   http://test.e-trading.kiev.ua/prozorrosale2/auctions/sync-all
    Go to   http://test.e-trading.kiev.ua/prozorrosale2/auctions/public
...
Подати цінову пропозицію
    ...
    ...  etrading.Пошук тендера по ідентифікатору  ${ARGUMENTS[0]}  ${ARGUMENTS[1]}
    ...  ELSE   Go To  http://test.e-trading.kiev.ua
